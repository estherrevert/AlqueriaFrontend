  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <h2 className="text-lg font-semibold text-text-main">Platos</h2>
        <button
          onClick={onCreate}
      ...
      {dishes.length === 0 ? (
        ...
        <>
          ...
          {Object.keys(dishesByCategory).length === 1 &&
          dishesByCategory[Object.keys(dishesByCategory)[0]].length ===
    ...
    <div className="group relative bg-white border border-neutral-200 rounded-xl p-4 hover:shadow-lg hover:scale-105 transition-all">
      <div className="space-y-3">
        <div>
          ...
          {dish.type && <p className="text-xs text-muted mt-1">{dish.type}</p>}
        </div>
