...
export default function DayCell({ date, dto, monthStart, today = false, size = "normal", }) {
    ...
    return (_jsxs("div", { onClick: onClick, className: [
            ...
            hover,
                        ...
                        ].join(" "), children: format(date, "d", { locale: es }) }), _jsxs("div", { className: "flex flex-wrap items-center gap-1", children: [f.tastingsCount > 0 && (_jsxs(Link, { to: `/calendar/tastings/${iso}`, className: `px-1.5 py-0.5 rounded-md bg-purple-100 text-purple-800 border border-purple-200 ${badgeText} font-medium shadow-sm hover:bg-purple-50`, title: "Ver todas las pruebas de men\u00FA de este d\u00EDa", onClick: (e) => e.stopPropagation(), children: ["Pruebas de men\u00FA (", f.tastingsCount, ")"] })), f.isBlocked && (_jsx("span", { className: `px-1.5 py-0.5 rounded-md bg-red-200/70 text-red-900 border border-red-300 ${badgeText} font-semibold shadow-sm`, children: "Bloqueado" }))] })] }), _jsxs("div", { className: "relative z-10 space-y-1", children: [f.events.slice(0, size === "compact" ? 2 : 3).map((e) => (_jsx(Link, { to: `/events/${e.id}`, className: [
